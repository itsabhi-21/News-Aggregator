    ...
    <div className="bg-[#0C144E] min-h-screen py-12 px-4">
      ...
      <ul className="flex flex-wrap justify-center gap-8">
        {articles.slice(0, isfullLength ? articles.length : 12).map((article, index) => (
          <li key={index} className="bg-[#080a15] backdrop-blur-md border border-white rounded-2xl shadow-xl flex flex-col transition-transform duration-300 hover:scale-105 max-w-sm w-full" >
              ...
              <h2 className="font-bold text-xl text-gray-200 mb-3">{article.title}</h2>
